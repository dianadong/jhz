...
int main()
{
	const char * singlepath = "H:\\GitDemo\\data_file\\singlegbk.txt";//字典：字/字频
	const char * wordpath1 = "H:\\GitDemo\\data_file\\wordgbknew.txt";//词典1：词组/词频
	...
	const char * qiefenpath = "H:\\GitDemo\\qiefen\\qiefenres.txt";//切分结果
